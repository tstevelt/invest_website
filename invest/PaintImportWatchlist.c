/*----------------------------------------------------------------------------
	Program : invest/PaintImportWatchlist.c
	Author  : Tom Stevelt
	Date    : 2019-2024
	Synopsis: Import a .csv file into the watchlist.
	Return  : 
----------------------------------------------------------------------------*/
...
void PaintImportWatchlist ()
{
	...
	printf ( "\tobjForm.action='wlupld.cgi';\n" );
	...
	printf ( "<%s>Import Stocks to Watchlist</%s>\n", STORY_TITLE, STORY_TITLE );
	...
	printf ( "<td>Replace or Append to Watchlist</td>\n" );
	printf ( "<td>\n" );
	...
	printf ( "<td>&nbsp;</td>\n" );
	printf ( "<td>\n" );
	printf ( "<input type='button' id='SubmitImportWatchlist' name='SubmitImportWatchlist' value='Import' onclick='javascript:RunImport();'>\n" );
	printf ( "</td>\n" );
	printf ( "</tr>\n" );
