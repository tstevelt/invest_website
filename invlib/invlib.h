...
#define		STYPE2_LARGE_CAP	'L'
#define		STYPE2_MID_CAP		'M'
#define		STYPE2_SMALL_CAP	'S'
#define		STYPE2_DEVELOPED	'D'
#define		STYPE2_EMERGING		'E'
#define		STYPE2_OTHER		'O'
#define		STYPE2_HUNDREDTH	'H'
#define		STYPE2_BASIS		'B'
